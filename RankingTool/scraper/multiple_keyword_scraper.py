...
def KeywordScrapeMultiple():
    ...
    for keyword in keywords:
        ...
        urlSearch ="https://www.amazon.de/s?k="+ keyword.keyword.replace(" ","+")+"&ref=nb_sb_noss_1"

        print("Retrieving data for " + keyword.keyword + "...")
        ...
        for page in range(1, crawler_settings.no_of_pages + 1):
            newUrl = "https://www.amazon.de/s?k=" + keyword.keyword.replace(" ", "+") + "&page=" + str(page)
            pages.append(newUrl)
